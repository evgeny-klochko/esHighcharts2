var COMMON = (function (common) {
  ...
  common.drawBordersPlotCompare = function (highchart, config, spacing, pointWidth, borderElement) {
    var elementName = '#' + config.container;
    var chart = highchart.series[1].chart;
    var dataLength = highchart.series[1].data.length;
    var data = highchart.series[0].data;
    var interval = data[1].clientX - data[0].clientX;
    interval = interval;
    var dividerPosition = 1;
    var rightRectLength = dataLength - dividerPosition;
    var dividerSpace = 12;
    var colors = config.colors;
    var width = chart.plotWidth;
    var height = chart.plotHeight + spacing * 2;
    var leftRectWidth = interval / 2 + highchart.series[0].data[0].barX - dividerSpace / 2 + pointWidth / 2;
    var rightRectWidth = highchart.chartWidth - leftRectWidth - dividerSpace - 1;
    var borderRadius = 3;
    var xStart = 1;
    var yStart = 1;
